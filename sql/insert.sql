...
INSERT INTO questions (question_text, category_id) VALUES ('Ef við værum að smíða vefsíðu og myndum vilja geta farið frá index.html yfir á about.html, hvað væri best að nota?', 1);
INSERT INTO questions (question_text, category_id) VALUES ('Í <head> á vefjum setjum við <meta charset="utf-8"> (eða það stafasett sem nota á), afhverju er það gert?', 1);
INSERT INTO questions (question_text, category_id) VALUES ('Það sem við getum gert til að forrita aðgengilega vefi er', 1);
INSERT INTO questions (question_text, category_id) VALUES ('Hvað er merkingarfræði í sambandi við námsefnið?', 1);
INSERT INTO questions (question_text, category_id) VALUES ('Fyrir eftirfarandi HTML / for the following HTML:
...
INSERT INTO questions (question_text, category_id) VALUES ('Ef við erum að nota nýtt gildi fyrir lit í CSS sem er ekki víst að sé stutt í öllum vöfrum, þá ættum við að', 2);
INSERT INTO questions (question_text, category_id) VALUES ('Í verkefnum höfum við unnið með „containers“ og „items“ sem hugtök, hvað á það við?', 2);
INSERT INTO questions (question_text, category_id) VALUES ('Þegar við notum flexbox hvað af eftirfarandi er satt? Gerið ráð fyrir að skjal sé lesið frá vinstri til hægri.', 2);
INSERT INTO questions (question_text, category_id) VALUES ('Hvað er skrifað út eftir að eftirfarandi kóði er keyrður?
...
console.log(item);', 3);
INSERT INTO questions (question_text, category_id) VALUES ('Þegar við berum saman gildi í JavaScript ættum við alltaf að nota þrjú samasem merki (`===`) því að', 3);
INSERT INTO questions (question_text, category_id) VALUES ('Þegar við notum `fetch` í JavaScript ætti ferlið við að sækja gögn að vera', 3);
